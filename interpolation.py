...
if __name__ == '__main__':
    ...
    data_root = '/data/zelinliu/MOT20/test'
    txt_path = '/data/zelinliu/sparsetrack/yolox_mix20/yolox_mix20_det/track_results'
    save_path = '/data/zelinliu/sparsetrack/yolox_mix20/yolox_mix20_det/track_results_dti'
